...
''', initNs={'void': VOID})
    ...
    def test_period_collection(self):
        ...
        self.assertEqual(urlparse(res1.headers['Location']).query, 'page=authority-view&backendID=http%3A%2F%2Flocalhost%2F&authorityID=trgkv') # noqa
        ...
        self.assertEqual(urlparse(res4.headers['Location']).query, 'page=authority-view&backendID=http%3A%2F%2Flocalhost%2F&authorityID=trgkv') # noqa
    ...
    def test_period_definition(self):
        ...
        self.assertEqual(res1.status_code, http.client.SEE_OTHER)
        self.assertEqual(urlparse(res1.headers['Location']).path, '/')
        self.assertEqual(urlparse(res1.headers['Location']).query, 'page=period-view&backendID=http%3A%2F%2Flocalhost%2F&authorityID=trgkv&periodID=trgkvwbjd') # noqa
        res2 = self.client.get(
        ...
        self.assertEqual(res4.status_code, http.client.SEE_OTHER)
        self.assertEqual(urlparse(res4.headers['Location']).path, '/')
        self.assertEqual(urlparse(res4.headers['Location']).query, 'page=period-view&backendID=http%3A%2F%2Flocalhost%2F&authorityID=trgkv&periodID=trgkvwbjd') # noqa
        res5 = self.client.get(
