...
def test_create_bag(active_identity, client, load_json):
...
@pytest.mark.client_auth_token('this-token-has-normal-permissions')
def test_if_none_match(active_identity, client, load_json):
    id = UUID('6f2c64e2-c65f-4e2d-b028-f89dfb71ce69')
    res = client.put(f'/bags/{id}', json=load_json('test-bag.json'))
    assert res.status_code == httpx.codes.CREATED
    res = client.get(
...
@pytest.mark.client_auth_token('this-token-has-normal-permissions')
def test_create_bag_requires_title(active_identity, client, load_json):
    id = UUID('6f2c64e2-c65f-4e2d-b028-f89dfb71ce69')
...
@pytest.mark.client_auth_token('this-token-has-normal-permissions')
def test_create_bag_requires_items_array(active_identity, client, load_json):
    id = UUID('6f2c64e2-c65f-4e2d-b028-f89dfb71ce69')
    bag_json = load_json('test-bag.json')
    del bag_json['items']
    res = client.put(f'/bags/{id}', json=bag_json)
...
@pytest.mark.client_auth_token('this-token-has-normal-permissions')
def test_create_bag_requires_minimum_of_two_items(
        active_identity,
        client,
        load_json
):
...
@pytest.mark.client_auth_token('this-token-has-normal-permissions')
def test_create_bag_requires_items_be_periodo_ids(
        active_identity,
        client,
        load_json
):
...
@pytest.mark.client_auth_token('this-token-has-normal-permissions')
def test_update_bag(active_identity, client, load_json):
    id = UUID('6f2c64e2-c65f-4e2d-b028-f89dfb71ce69')
    res = client.put(f'/bags/{id}', json=load_json('test-bag.json'))
    assert res.status_code == httpx.codes.CREATED
...
@pytest.mark.client_auth_token('this-token-has-normal-permissions')
def test_create_bag_using_jsonld(active_identity, client, load_json):
    id = UUID('6f2c64e2-c65f-4e2d-b028-f89dfb71ce69')
    res = client.put(f'/bags/{id}', json=load_json('test-bag.json'))
