...
def test_get_history(
    ...
    assert (
        HOST['h#patch-1'],
        FOAF.page,
        HOST['patches/1/patch.jsonpatch']
    ) in g
    ...
    check_time(
        g.value(subject=HOST['h#change-2'], predicate=PROV.startedAtTime)
    )
    check_time(
        g.value(subject=HOST['h#change-2'], predicate=PROV.endedAtTime)
    )
    ...
    check_comment(
        1,
        'https://orcid.org/1234-5678-9101-112X',
        'Here is my patch'
    )
    check_comment(
        2,
        'https://orcid.org/1211-1098-7654-321X',
        'Looks good to me'
    )
    ...
    assert (
        HOST['h#patch-2'],
        FOAF.page,
        HOST['patches/2/patch.jsonpatch']
    ) in g
